...
QVector<double> FindPeaksDirect(QVector<double> const& data, int minDistance = 1, std::function<bool(double, double)> compare = std::less<bool>()); // Наивный поиск локальных экстремумов
